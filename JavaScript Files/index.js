...
///////////////////////////////////////////////////////////////////////////////////////////////////////
//JAVASCRIPT TO SUBMIT WEBPAGE REVIEW
/*function SendMail()
{
  var sendButton = document.getElementById("submitButton");
  var params = {
    from_name : document.getElementById("nameBox").value,
    from_message : document.getElementById("commentsBox").value,
    from_rating : document.getElementById("ratingBox").value
  }
  emailjs.send("service_y9em7zm","template_5erwsic", params).then(function (res){
...
*/
  $("#submitButton").click(function(){
    ...
    emailjs.send("service_y9em7zm","template_5erwsic", params).then(function (res){
      alert("Your Website Review Was Successfully Submitted ! ");
    }
    )
  });